...
# 🎤 TTS Client (v1beta1 for timepoints)
...
def synthesize_ssml(ssml):
    """Generate audio + timepoints from Google Cloud TTS v1beta1."""
...
def upload_to_gcs(local_path, destination_blob_name):
    """Upload local file to GCS and return public URL."""
...
def generate():
    try:
        ...
        # 🎞️ Build black background video with captions
